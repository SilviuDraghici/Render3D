...
void colorsDisplayMain(int argc, char *argv[]) {
    if (argc < 5) {
        fprintf(stderr, "Colorss Display: Can not parse input parameters\n");
        fprintf(stderr, "USAGE: Render3D 3 size antialias output_name\n");
